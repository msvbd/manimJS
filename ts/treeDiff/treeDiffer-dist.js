...
treeDiffer.TreeNode.prototype.isEqual = function (otherNode) {
  if (this.node.nodeType === Node.TEXT_NODE) {
    return (
      ...
      otherNode.node.innerText === this.node.innerText
    );
  } else {
 ...
 */
treeDiffer.TreeNode.prototype.getOriginalNodeChildren = function () {
  var i,
    ilen,
    childNode,
    children = [],
 ...
 * @param {Object} transactions Temporary store of transactions between trees
 */
treeDiffer.Differ.prototype.findMinimumTransactions = function (
  keyRoot1,
  keyRoot2,
  transactions
) {
 ...
 */
treeDiffer.Differ.prototype.getCorrespondingNodes = function (
  transactions,
  oldTreeLength,
  newTreeLength
) {
